                                ...
                                echo "<tbody>";
                                    echo "<tr>";
                                        ...
                                        if(in_array($fixture->time->status, array('LIVE', 'HT'))) {
                                            echo "<td scope='row'>" . date('Y-m-d H:i', strtotime($fixture->time->starting_at->date_time)) . " <span style='color:#FF0000'>" . $fixture->time->status . "</span></td>";
                                        } else {
                                            echo "<td scope='row'>" . date('Y-m-d H:i', strtotime($fixture->time->starting_at->date_time)) . "</td>";
                                        }
                                        echo "<td scope='row'><a href=" . route('fixturesDetails', ['id' => $fixture->id]) . "><i class='fa fa-info-circle'></i></a></td>"; //link to details page (fixtures/{id})
                                    echo "</tr>";
                        }
