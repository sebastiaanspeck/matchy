                ...
                @if(count($statistics) > 0)
                    ...
                    <table class="table table-sm table-borderless">
                        @foreach ($stats_by_type as $row)
                            ...
                            @endphp
                            <tr>
                                <td colspan="2" class="text-start"><span>{{ $home_display }}</span></td>
                                <td colspan="2" class="text-center"><span>{{ $row['label'] }}</span></td>
                                <td colspan="2" class="text-end"><span>{{ $away_display }}</span></td>
                            </tr>
                            <tr>
