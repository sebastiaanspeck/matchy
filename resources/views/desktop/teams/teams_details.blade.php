        ...
        <div id="heading" class="text-center">
            <table width="100%">
                ...
                <tr>
                    ...
                    @endphp
                    <td class="align-top"><h3><a href="{{ route("setFavoriteTeams", ["id" => $team->id]) }}"><i class="{{ $favorite_team }} fa-star fa-fw fa-xs" aria-hidden="true" style="transform: translate(10%, -10%);"></i></a>&nbsp;{{$team->name}}</h3></td>
                </tr>
                @if(isset($coach))
                    <tr>
